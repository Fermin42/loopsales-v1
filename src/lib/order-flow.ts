...
export const STATUS_LABELS: Record<string, string> = {
  ...
  ready_for_warehouse: "Enviado a bodega",
  awaiting_warehouse: "Pendiente en bodega",
  in_warehouse: "En bodega",
  ready_for_driver: "Enviado a reparto",
  awaiting_driver: "Pendiente en reparto",
  in_transit: "En ruta al cliente",
  delivered: "Entregado al cliente",
  returning_to_billing: "Regresando a facturación",
  awaiting_billing_return: "Devolución pendiente",
  returned_to_billing: "Devuelto a facturación",
  with_collections: "En cartera",
  awaiting_collections: "Pendiente en cartera",
  closed: "Cerrado",
...
export const EVENT_LABELS: Record<OrderEventType, string> = {
  ...
  warehouse_receives: "Recibido en bodega",
  warehouse_to_driver: "Enviado a reparto",
  driver_receives: "Recibido por reparto",
  driver_delivers_customer: "Entregado al cliente",
  warehouse_delivers_customer: "Entregado al cliente (retiro directo)",
  driver_returns_billing: "Soporte devuelto a facturación",
  billing_receives_return: "Facturación recibió soporte",
  billing_to_collections: "Enviado a cartera",
  collections_receives: "Recibido en cartera",
  transfer_pending: "Transferencia pendiente",
  transfer_accepted: "Recepción aceptada",
  transfer_rejected: "Recepción rechazada",
  admin_edit: "Ajuste administrativo",
};
